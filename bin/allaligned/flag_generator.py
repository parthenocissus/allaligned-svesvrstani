...
from bin.allaligned.flag_layout import FlagLayout
from bin.allaligned.symbol_engine import SymbolEngine
from bin.allaligned.input_data_utils import InputDataUtil as IU
...
class GenFlag:
    ...
    def __init__(self, width=150, height=100, input_params=None,
                 ...
                 rules_path='static/space/svesvrstani/conf/flag-rules.json',
                 symbols_path='static/space/svesvrstani/conf/flag-symbols.json'):
        ...
        self.symbols_typical_dir = 'static/space/svesvrstani/flag-symbols/typical/'
        self.symbols_other_dir = 'static/space/svesvrstani/flag-symbols/other/'
        ponders_path = 'static/space/svesvrstani/conf/input-ponders.json'
